...
const agesUpperThanEigth = ages.filter((age) => age > 18);
console.log(agesUpperThanEigth);
...
const streamerLeague = streamers.filter(
...
const streamersLegendsUpper = streamers2.filter((streamer) => {
...
console.log(streamersLegendsUpper);
